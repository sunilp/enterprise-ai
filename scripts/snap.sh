...
W=${3:-1440}; H=${4:-2400}
"$HS" --headless --disable-gpu --no-sandbox --hide-scrollbars --user-data-dir=$(mktemp -d) --window-size=$W,$H --virtual-time-budget=6000 --screenshot="$2" "http://127.0.0.1:4333/enterprise-ai/$1" 2>/dev/null
